The site - <a href="http://www.curriculumvitae.co.za/" target="_blank">Curriculum Vitae</a>&nbsp;- is currently very tightly build. Which is very bad. All data and functions - except for the Mail Server - are in the main application, which was fine while I was developing it but recently I have been wanting to expand it with new features but they require a bit of a rewrite of some of the functions.<br />
<div>
<br /></div>
<div>
<br />
...
<br /></div>
<div>
Got some work ahead of me, so let's do this.</div>
<div>
<br /></div>